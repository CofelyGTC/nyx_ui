  ...
  >
    <el-form v-model="newRec._source">
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
          ...
          <el-row>
              <el-col :span=8>
                  <el-form-item label="Nbre de Personnes" :label-width="formLabelWidth">
                      <el-input-number  v-model="newRec._source.nbre_pers" :step="1" :min="1">
                      </el-input-number>
                  </el-form-item>
              </el-col>
              <el-col :span=8>
                  <el-form-item label="Prix de reviens" :label-width="formLabelWidth">
                      <el-input-number  v-model="newRec._source.prix_reviens" :step="0.01" :min="0">
                      </el-input-number>
                  </el-form-item>
              </el-col>
              <el-col :span=8>
                  <el-form-item label="Prix final" :label-width="formLabelWidth">
                      <el-input-number  v-model="newRec._source.prix" :step="0.01" :min="0">
                      </el-input-number>
                  </el-form-item>
              </el-col>
          </el-row>
