      ...
      <el-form>
          <el-row>
                ...
                <el-form-item label="Queue" :label-width="formLabelWidth">
                  <el-input size="small" v-model="currentConfig.config.queue" autocomplete="off"></el-input>
                </el-form-item>
                </el-col>
                <el-col :span="12">                  
                <el-form-item label="File Types" :label-width="formLabelWidth">
                  <el-input size="small" placeholder=".docx,.doc or nothing for all types" v-model="currentConfig.config.filetypes" autocomplete="off"></el-input>
                </el-form-item>                              
                </el-col>
              </el-row>
              ...
              <el-form-item label="Tip" :label-width="formLabelWidth">
                  <el-input size="small" v-model="currentConfig.config.tip" autocomplete="off"></el-input>
                </el-form-item>
              </el-row>        
      </el-form>
      <div></div>
