<template>
  <div style="width: 100%">
  <el-row class="ordershop-biscuit-container" style="width: 100%" >
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      "schamps/check_order?demandor="+demandor+"&category=Biscuit&token=" +
