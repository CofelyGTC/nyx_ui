<template>
  <div style="width: 100%">
  <el-row class="ordershop-bavarois-container" style="width: 100%" >
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      "schamps/check_order?demandor="+demandor+"&category=Bavarois&token=" +
