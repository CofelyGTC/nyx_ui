<template>
  <div style="width: 100%">
  <el-row class="ordershop-other-container" style="width: 100%" >
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      "schamps/check_order?demandor="+demandor+"&category=Other&token=" +
