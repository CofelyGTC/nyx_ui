    ...
    <el-form v-model="newRec._source">
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item
              placeholder="Décrivez ce contrat..."
              label="Description : "
        ...
        <el-row>
          ...
          >
            ...
            >
              {{ prod.CODE }} - {{ prod.Label }}
              <el-checkbox
                v-model="prod.checked"
                @change="checkChange(prod)"
              ></el-checkbox>
            </li>
          </ul>
        </el-row>
  ...
  methods: {
    ...
    getProductsList: function () {
      var url =
        ...
        'lambdas/8/get_products_list?apikey=' +
      ...
      axios.post(url, body).then((response) => {
        ...
        for (var key in this.productsList) {
          if (
            this.newRec._source.products.includes(
              this.productsList[key]['CODE']
            )
          ) {
