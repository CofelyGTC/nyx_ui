  ...
  >
    <el-form v-model="newRec._source">
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
        <h1>
          {{ newRec._source.shop }} ({{ newRec._source.shopid }}) {{ strDt }}
        </h1>
        <el-row>
          <el-col :span="12">
            <el-form-item
              label="Bancontact (1er Ticket)"
              :label-width="formLabelWidth"
            >
              <el-input-number
                v-model="newRec._source.bancontact"
          ...
          <el-col :span="12">
            <el-form-item
              label="Bancontact (2e Ticket)"
              :label-width="formLabelWidth"
            >
              <el-input-number
                v-model="newRec._source.bancontact2"
                :disabled="this.disabled"
                :step="0.01"
                :min="0"
              ></el-input-number>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Sandwichs" :label-width="formLabelWidth">
              <el-input-number
                v-model="newRec._source.sandwichs"
                :disabled="this.disabled"
                :step="0.01"
                :min="0"
              ></el-input-number>
          ...
          <el-col :span="12">
            <el-form-item label="Confiserie" :label-width="formLabelWidth">
              <el-input-number
                v-model="newRec._source.confiserie"
                :disabled="this.disabled"
                :step="0.01"
                :min="0"
              ></el-input-number>
