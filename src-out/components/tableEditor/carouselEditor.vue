  ...
  >
    ...
    <el-form :model="newRec" :rules="rules" ref="newRec">
      <el-row style="text-align: left">
        <el-col :span="12">
          <el-button @click="setFocus('carName')" type="text"
            >Carousel Name</el-button
          >
        </el-col>
        <el-col
          :span="12"
      ...
      <el-row style="height: 40px">
        <el-button
          size="small"
          type="primary"
          @click="addExistingView"
          class="add-view-button"
          :icon="ElIconPlus"
          >Add Exsting view</el-button
        >
        <el-button
          size="small"
          type=""
...
export default {
    ...
    rules: {
      _source: {
        name: [
          {
            required: true,
            message: 'Carousel name cannot be empty',
            trigger: 'change',
          },
        ],
      },
  ...
  methods: {
    closeDialog: function () {
      if (
        !(this.loading || !this.recchanged || this.newRec._source.name == '')
      ) {
