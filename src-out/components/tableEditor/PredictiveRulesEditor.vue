    ...
    <el-form v-model="newRec._source">
      ...
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
        ...
        <el-row>
          <el-form-item label="Select: " :label-width="formLabelWidth">
            ...
            >
              <el-option
                v-for="(item, type) in buildingList"
                :key="type"
                :label="item"
                :value="item"
              >
      ...
      <div v-if="ruleType == 'generic'">
        ...
        >
          ...
          <el-row style="text-align: left">
            ...
            <el-col
              v-for="(condition, index) in this.conditionsWeather"
              :key="index"
            >
              <el-row>
                <el-col :span="4">
                ...
                <el-col :span="1">
                  <center>
                    <el-button
                      @click="removeWeatherCondition(index)"
                      type="danger"
                      :icon="ElIconDelete"
                      circle
                    >
            ...
            <el-col :span="6">
              <el-form-item label="Table" :label-width="formLabelWidth">
                <el-select v-model="weatherTable">
                  <el-option
                    v-for="(item, id) in weatherTables"
                    :key="id"
                    :label="item"
                    :value="item"
                  ></el-option>
          ...
          <el-row>
            ...
            <el-col
              v-for="(condition, index) in this.conditionsPLC"
              :key="index"
            >
              <el-row>
                <el-col :span="4">
                ...
                <el-col :span="4">
                  <center>
                    <el-button
                      @click="removePLCCondition(index)"
                      type="danger"
                      :icon="ElIconDelete"
                      circle
                    >
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="PLC:" :label-width="formLabelWidth">
                <el-select
                  v-model="conditionPLC"
                  filterable
                  placeholder="Select"
                  @change="changePLCCondition"
                >
                  <el-option
                    v-for="(item, type) in PLCs"
                    :key="type"
                    :label="item"
                    :value="item"
                  >
            ...
            <el-col :span="6">
              <el-form-item label="Tag:" :label-width="formLabelWidth">
                <el-select
                  v-model="conditionPLCTag"
                  filterable
                  placeholder="Select"
                >
                  <el-option
                    v-for="(item, type) in tagsPLCCondition"
                    :key="type"
                    :label="item"
                    :value="item"
                  >
            ...
            <el-col :span="5">
              <el-form-item label="Type:" :label-width="formLabelWidth">
                <el-select v-model="actionType" filterable placeholder="Select">
                  <el-option
                    v-for="(item, type) in actionsTypes"
                    :key="type"
                    :label="item"
                    :value="item"
                  >
        ...
        >
          ...
          <el-row>
            ...
            >
              <el-input
                size="small"
                v-model="customRuleQueue"
                autocomplete="off"
                placeholder="/QUEUE/NAME_OF_LAMBDA...."
              ></el-input>
            </el-form-item>
          </el-row>
        </el-card>
      ...
      <div>
        ...
        >
          ...
          <el-row style="text-align: left">
            <el-col :span="6">
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, type) in nextRunTypes"
                    :key="type"
                    :label="item"
                    :value="item"
                  >
          ...
          <el-row style="text-align: left">
            <el-col
              v-for="(interval, index) in this.executionIntervals"
              :key="index"
            >
              <el-row style="text-align: left">
                <el-col :span="6">
                ...
                <el-col :span="6">
                  <center>
                    <el-button
                      @click="removeExecutionInterval(index)"
                      type="danger"
                      :icon="ElIconDelete"
                      circle
                    >
    ...
    nextRun: function () {
      if (this.nextRunType == 'interval') {
        var nextRun = new Date(
          this.lastRun.getTime() + this.interval * 1000 * 60 * 60
        )
        return nextRun
      } else {
  ...
  methods: {
    ...
    getBuildingsList: function () {
      var url =
        ...
        'lambdas/5/get_predictive_buildings_lists?apikey=' +
    ...
    getCities: function () {
      var url =
        this.$store.getters.apiurl +
        'lambdas/5/get_predictive_cities?apikey=' +
        this.$store.getters.creds.token
      var body = {}
      axios.post(url, body).then((response) => {
        console.log(response)
    ...
    getPLCs: function () {
      var url =
        this.$store.getters.apiurl +
        'lambdas/5/get_predictive_plc_lists?apikey=' +
        this.$store.getters.creds.token
    ...
    getTagsAction: function () {
      var url =
        this.$store.getters.apiurl +
        'lambdas/5/get_predictive_tags_lists?apikey=' +
        this.$store.getters.creds.token
