          ...
          <el-card shadow="hover" :body-style="{ padding: '10px' }">
            <el-row>
              <el-col :span="8">
                ...
                >
                  <el-input
                    size="small"
                    v-model="newRec._source.Availbility"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="8">
                ...
                >
                  <el-input
                    size="small"
                    v-model="newRec._source.Conditionnement"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
                  label="Filtre invendu"
                  :label-width="formLabelWidth2"
                >
                  <el-input
                    size="small"
                    v-model="newRec._source.Filter_unsale"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="newRec._source.lieuPreparation"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, idPrepa) in lieuPrepa"
                      :key="idPrepa"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="newRec._source.lieuProduction"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, idProd) in lieuProd"
                      :key="idProd"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    placeholder="ex: vente à l'unité"
                    size="small"
                    v-model="newRec._source.unite_vente"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <el-col :span="4">
                <el-form-item label="Prix TVAC" :label-width="formLabelWidth2">
                  <el-input-number
                    size="small"
                    v-model="newRec._source.Prix_TVAC"
                    autocomplete="off"
                    :step="0.01"
                  ></el-input-number>
                </el-form-item>
              ...
              <el-col :span="4">
                <el-form-item label="Taux TVA" :label-width="formLabelWidth2">
                  <el-input-number
                    size="small"
                    v-model="newRec._source.Taux_TVA"
                    autocomplete="off"
                    :step="0.01"
                  ></el-input-number>
                </el-form-item>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="Niveau 1" :label-width="formLabelWidth2">
                  <el-select
                    v-model="newRec._source.sortLvl1"
                    filterable
                    placeholder="Sélectionner"
                    @change="lvl1Change()"
                  >
                    <el-option
                      v-for="(item, id1) in lvl1"
                      :key="id1"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="8">
                <el-form-item label="Niveau 2" :label-width="formLabelWidth2">
                  <el-select
                    v-if="newRec._source.sortLvl1 == 'Boulangerie'"
                    filterable
                    v-model="newRec._source.sortLvl2"
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id2) in lvl2"
                      :key="id2"
                      :label="item"
                      :value="item"
                    >
                  ...
                  <el-select
                    v-else-if="newRec._source.sortLvl1 == 'Pâtisserie'"
                    filterable
                    v-model="newRec._source.sortLvl2"
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id2) in lvl2_pat"
                      :key="id2"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="newRec._source.sortLvl3"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id3) in lvl3"
                      :key="id3"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="12">
                <el-form-item
                  label="Fruits Cuits / Pas Cuits"
                  :label-width="formLabelWidth2"
                >
                  <el-select
                    v-model="newRec._source.sortLvl4"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id4) in lvl4"
                      :key="id4"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item
                  label="Avec/Sans Fruits"
                  :label-width="formLabelWidth2"
                >
                  <el-select
                    v-model="newRec._source.sortLvl5"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id5) in lvl5"
                      :key="id5"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="12">
                <el-form-item label="Taille" :label-width="formLabelWidth2">
                  <el-select
                    v-model="newRec._source.sortLvl6"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id6) in lvl6"
                      :key="id6"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item
                  label="Avec/Sans Crème Fraîche"
                  :label-width="formLabelWidth2"
                >
                  <el-select
                    v-model="newRec._source.sortLvl7"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id7) in lvl7"
                      :key="id7"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="12">
                <el-form-item
                  label="Type de Fruits"
                  :label-width="formLabelWidth2"
                >
                  <el-select
                    v-model="newRec._source.sortLvl8"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id8) in lvl8"
                      :key="id8"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              <el-col :span="12">
                ...
                >
                  <el-select
                    v-model="newRec._source.sortLvl9"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id9) in lvl9"
                      :key="id9"
                      :label="item"
                      :value="item"
                    >
              ...
              <el-col :span="12">
                <el-form-item label="Autre" :label-width="formLabelWidth2">
                  <el-select
                    v-model="newRec._source.sortLvl10"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, id10) in lvl10"
                      :key="id10"
                      :label="item"
                      :value="item"
                    >
            ...
            <el-row>
              ...
              >
                ...
                >
                  ...
                  <el-option
                    key="3"
                    label="Toujours Disponible Sauf"
                    value="except"
                  ></el-option>
                </el-select>
              </el-form-item>
              <div v-if="availabilityType == 'days'">
                <el-row>
                  ...
                  <el-col :span="3">
                    ...
                    >
                      <el-switch
                        v-model="availabilityConf.wednesday"
                      ></el-switch>
                    </el-form-item>
                  </el-col>
                  <el-col :span="3">
                    <el-form-item label="Jeudi:" :label-width="formLabelWidth2">
                      <el-switch
                        v-model="availabilityConf.thursday"
                      ></el-switch>
                    </el-form-item>
                  </el-col>
                  <el-col :span="3">
                  ...
                  <el-col :span="3">
                    ...
                    >
                      <el-switch
                        v-model="availabilityConf.saturday"
                      ></el-switch>
                    </el-form-item>
                  </el-col>
                  <el-col :span="3">
                ...
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="De:" :label-width="formLabelWidth2">
                      <el-date-picker
                        v-model="availabilityConf.period"
                        type="daterange"
                        range-separator="à"
              ...
              <div v-else-if="availabilityType == 'except'">
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="De:" :label-width="formLabelWidth2">
                      <el-date-picker
                        v-model="availabilityConf.except"
                        type="daterange"
                        range-separator="à"
                        start-placeholder="Date de début"
                        end-placeholder="Date de fin"
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item
                  ...
                  :label-width="formLabelWidth2"
                >
                  <el-switch v-model="newRec._source.quota_enable"> </el-switch>
                </el-form-item>
              </el-col>
              <el-col :span="6">
          ...
          <el-card>
            ...
            <el-row>
              <el-form-item label="Catégorie" :label-width="formLabelWidth2">
                <el-select
                  v-model="newRec._source.factCategory"
                  filterable
                  placeholder="Sélectionner"
                >
                  <el-option
                    v-for="(item, idFact) in factCategories"
                    :key="idFact"
                    :label="item"
                    :value="item"
                  >
          ...
          <el-card>
            ...
            <el-row>
              ...
              >
                <el-input
                  size="small"
                  v-model="newRec._source.fournisseur_code"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-row>
            <el-row>
              <el-form-item
                label="Prix Fournisseur (HTVA): "
                :label-width="formLabelWidth2"
              >
                <el-input-number
                  size="small"
                  v-model="newRec._source.fournisseur_prix"
                  :step="0.01"
                  :min="0"
                ></el-input-number>
              </el-form-item>
            ...
            <el-input size="small" v-model="newRec._source.fournisseur" autocomplete="off"></el-input>
           </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="Numéro fournisseur : " :label-width="formLabelWidth2">
            <el-input size="small" v-model="newRec._source.fournisseur_num" autocomplete="off"></el-input-->
              </el-form-item>
            </el-row>
          </el-card>
        </el-collapse-item>
            ...
            >
              <el-row>
                <el-table
                  ...
                  style="width: 100%"
                >
                  <el-table-column width="180" label="Convention" sortable>
                    <template slot-scope="scope">
                      {{ scope.row.CODE }}
                    </template>
                  </el-table-column>
                  <el-table-column width="180" label="Description" sortable>
                    <template slot-scope="scope">
                      {{ scope.row.description }}
                    </template>
                  </el-table-column>
                  <el-table-column width="180" label="Inclus ?" sortable>
                    <template slot-scope="scope">
                      <el-checkbox
                        v-model="scope.row.included"
                        @change="
                          changeConvention(scope.row.CODE, scope.row.included)
                        "
                      ></el-checkbox>
                    </template>
                  </el-table-column>
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="Coût (€): " :label-width="formLabelWidth2">
                  <el-input-number
                    size="small"
                    v-model="newRec._source.cout_prod"
                    :step="0.01"
                    :min="0"
                  ></el-input-number>
                </el-form-item>
  ...
  methods: {
    ...
    getFournisseurs: function () {
      ...
      var url =
        ...
        'lambdas/2/get_fournisseurs?apikey=' +
    ...
    saveRecord: function () {
      ...
      this.newRec._source.availabilityConf = JSON.stringify(
        this.availabilityConf
      )
    ...
    getConventions() {
      var url =
        this.$store.getters.apiurl +
        'lambdas/8/get_conventions_by_product?apikey=' +
        this.$store.getters.creds.token
    ...
    changeConvention(CODE, included) {
      ...
      var url =
        this.$store.getters.apiurl +
        'lambdas/8/set_conventions_by_product?apikey=' +
        this.$store.getters.creds.token
      var query = {
        _id: this.newRec._source['CODE'],
        convention: CODE,
        included: included,
      }
      axios.post(url, query).then((response) => {
