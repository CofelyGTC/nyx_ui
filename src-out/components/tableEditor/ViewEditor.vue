  ...
  >
    ...
    <el-form :model="newRec" ref="ruleForm" :rules="rules">
      <el-row style="text-align: left">
        ...
        <el-col :span="8">
          <el-button @click="setFocus('summary')" type="text"
            >Summary</el-button
          >
        </el-col>
        <el-col :span="8">
      ...
      <el-row style="text-align: left">
        ...
        <el-col :span="8" class="padding-right">
          <el-form-item>
            <el-input
              ref="summary"
              size="small"
              v-model="newRec._source.summary"
              autocomplete="off"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col
          :span="8"
          v-if="
            newRec._source.client || $store.getters.creds.hasPrivilege('admin')
          "
        >
          <el-input
      ...
      <el-row style="text-align: left">
        <el-col :span="8">
          <el-button @click="setFocus('duration')" type="text"
            >Duration (ms)</el-button
          >
        </el-col>
        <el-col :span="16">
          <el-button @click="setFocus('description')" type="text"
        ...
        <el-col :span="8" style="text-align: left">
          <el-form-item prop="_source.type">
            ...
            >
              <el-option
                v-if="
                  !$store.getters.creds.hasPrivilege('optiboard-nokibana') ||
                  $store.getters.creds.hasPrivilege('admin')
                "
                label="Kibana"
                value="kibana"
              ></el-option>
      ...
      <span shadow="never" v-if="newRec._source.type === 'optiboard'">
        <el-row style="text-align: left">
          ...
          <el-col :span="16">
            <el-button @click="setFocus('youtube')" type="text"
              >Youtube playlist</el-button
            >
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="8" style="text-align: left">
            <el-form-item :label-width="formLabelWidth">
              <el-button
                :disabled="
                  newRec._source.kibanaId == null || dashboards.length == 0
                "
                size="small"
                type="danger"
          ...
          <el-col :span="8" v-if="newRec._source.type === 'kibana'">
            <el-form-item label :label-width="formLabelWidth">
              ...
              >
                <el-option
                  label="5 seconds"
                  value="refreshInterval:(pause:!f,value:5000)"
                ></el-option>
                <el-option
                  label="10 seconds"
                  value="refreshInterval:(pause:!f,value:10000)"
                ></el-option>
                <el-option
                  label="30 seconds"
                  value="refreshInterval:(pause:!f,value:30000)"
                ></el-option>
                <el-option
                  label="45 seconds"
                  value="refreshInterval:(pause:!f,value:45000)"
                ></el-option>
                <el-option
                  label="1 minute"
                  value="refreshInterval:(pause:!f,value:60000)"
                ></el-option>
                <el-option
                  label="5 minutes"
                  value="refreshInterval:(pause:!f,value:300000)"
                ></el-option>
                <el-option
                  label="15 minutes"
                  value="refreshInterval:(pause:!f,value:900000)"
                ></el-option>
                <el-option
                  label="30 minutes"
                ...
                <el-option
                  label="1 hour"
                  value="refreshInterval:(pause:!f,value:3600000)"
                ></el-option>
                <el-option
                  label="2 hours"
                  value="refreshInterval:(pause:!f,value:7200000)"
                ></el-option>
                <el-option
                  label="12 hours"
                  value="refreshInterval:(pause:!f,value:43200000)"
                ></el-option>
                <el-option
                  label="1 day"
                  value="refreshInterval:(pause:!f,value:86400000)"
                ></el-option>
              </el-select>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    uploadPictureSuccess: function (response, file, fileList) {
      ...
      this.newRec._source.target =
        nurl + '/public/pictures/singleimage.html?image=' + file.name
