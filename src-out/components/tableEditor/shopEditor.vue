            ...
            <el-collapse-item title="Informations générales" name="1">
              <el-card shadow="hover" :body-style="{ padding: '10px' }">
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item
                      label="Convention Produits"
                      :label-width="formLabelWidth2"
                    >
                      <el-select
                        v-model="productsContract"
                        placeholder="Sélectionner"
                        @change="contractChange(productsContract)"
                      >
                        <el-option
                          v-for="(item, id) in productsContractTypes"
                          :key="id"
                          :label="item.ID"
                          :value="item.ID"
                        >
              ...
              <el-card>
                ...
                <el-row>
                  ...
                  >
                    <el-select
                      ...
                      placeholder="Sélectionner"
                      @change="commissionChange(commissionType)"
                    >
                      <el-option
                        v-for="(item, id) in commissionTypes"
                        :key="id"
                        :label="item"
                        :value="item"
                      >
                ...
                <div v-else-if="commissionType == 'Intervalles'">
                  ...
                  <el-row style="text-align: left">
                    ...
                    <el-col
                      v-for="(interval, index) in commissionIntervals"
                      :key="index"
                    >
                      <el-row>
                        <el-col :span="4">
                  ...
                  <el-row>
                    ...
                    <el-col :span="4">
                      <el-input
                        size="small"
                        v-model="newIntervalName"
                        autocomplete="off"
                        placeholder="Nom intervalle..."
                      ></el-input>
                    </el-col>
                    <el-col :span="4">
                      <label>Seuil:</label>
                  ...
                  <el-row>
                    ...
                    <el-col :span="4">
                      <el-input-number
                        size="small"
                        v-model="newIntervalForfaitEtudiant"
                        autocomplete="off"
                        :min="0"
                        :step="1"
                      />
            ...
            <el-collapse-item title="Facturation" name="3">
              ...
              <el-card>
                ...
                <el-row>
                  ...
                  <el-form-item
                    label="Catégorie de Facturation: "
                    :label-width="formLabelWidth2"
                  >
                    <el-select
                      placeholder="Sélectionner"
                      v-model="categoryFact"
                    >
                  ...
                  <el-form-item
                    label="N° Carte de dépôt: "
                    :label-width="formLabelWidth2"
                  >
                    <el-input
                      size="small"
                      v-model="newRec._source.bankcard"
                      autocomplete="off"
                      placeholder="...."
                    ></el-input>
                  </el-form-item>
              ...
              <el-card>
                ...
                <el-row>
                  ...
                  >
                    ...
                    >
                      <el-option
                        v-for="(item, id2) in horrairesTypes"
                        :key="id2"
                        :label="item"
                        :value="item"
                      >
                ...
                <el-row>
                  <el-form-item
                    label="Etudiants (nombre d'heures): "
                    :label-width="formLabelWidth2"
                  >
                    <el-input-number
                      size="small"
  ...
  methods: {
    ...
    getContracts() {
      var url =
        ...
        'lambdas/8/get_products_contracts?apikey=' +
