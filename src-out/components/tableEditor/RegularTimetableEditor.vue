    ...
    <div>
      <el-form v-model="newRec._source">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="Nom  du DB: " :label-width="formLabelWidth">
              <el-input
                v-model="DB"
                placeholder="Veuillez enter un nom... (DBXX)"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="4">
            <el-form-item
              v-if="!newRec._source.nextGen"
              label="Encodage Decimal : "
              :label-width="formLabelWidth"
            >
        ...
        <el-row>
          <el-col :span="4">
            <el-form-item
              label="Dero Covid Matin: "
              :label-width="formLabelWidth"
            >
              <el-switch
                v-model="newRec._source.dero_covid_morning"
              ></el-switch>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            ...
            >
              <el-input-number
                v-model="newRec._source.dero_covid_morning_mins"
                size="small"
                :disabled="!newRec._source.dero_covid_morning"
              ></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item
              label="Dero Covid Soir: "
              :label-width="formLabelWidth"
            >
          ...
          <el-col :span="5">
            ...
            >
              <el-input-number
                v-model="newRec._source.dero_covid_mins"
                :disabled="!newRec._source.dero_covid"
                size="small"
              ></el-input-number>
            </el-form-item>
          </el-col>
            ...
            <el-form-item label="ON 1: " :label-width="formLabelWidth2">
              <el-time-select
                :start="
                  ...
                  { start: '00:00', end: '23:45', step: '00:15' }.start
                "
                :end="
                  { start: '00:00', end: '23:45', step: '00:15' } &&
                  { start: '00:00', end: '23:45', step: '00:15' }.end
                "
                :step="
                  { start: '00:00', end: '23:45', step: '00:15' } &&
                  { start: '00:00', end: '23:45', step: '00:15' }.step
                "
                :min-time="
                  { start: '00:00', end: '23:45', step: '00:15' } &&
                  { start: '00:00', end: '23:45', step: '00:15' }.minTime
                "
                :max-time="
                  { start: '00:00', end: '23:45', step: '00:15' } &&
                  { start: '00:00', end: '23:45', step: '00:15' }.maxTime
                "
                v-model="weekStart1"
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.mondayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.mondayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.mondayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.mondayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.tuesdayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.tuesdayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.tuesdayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.tuesdayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.wednesdayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.wednesdayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.wednesdayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.wednesdayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.thursdayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.thursdayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.thursdayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.thursdayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.fridayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.fridayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.fridayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.fridayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.saturdayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.saturdayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.saturdayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.saturdayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
          ...
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.sundayON1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.sundayOFF1"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.sundayON2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
          <el-col :span="5" style="text-align: center">
            <el-time-select
              ...
              :max-time="
                ...
                { start: '00:00', end: '23:45', step: '00:15' }.maxTime
              "
              v-model="newRec._source.sundayOFF2"
              placeholder="Choisissez un horaire"
            ></el-time-select>
          </el-col>
        </el-row>
