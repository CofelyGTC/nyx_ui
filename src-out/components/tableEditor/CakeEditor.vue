  ...
  >
    ...
    >
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
        <el-form-item
          v-if="editableMagasin"
          label="Magasin"
          :label-width="formLabelWidth"
        >
          <el-input
            :disabled="editableMagasin"
            size="small"
            v-model="magasinStr"
            autocomplete="off"
          ></el-input>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="Prénom" :label-width="formLabelWidth">
              <el-input
                size="small"
                v-model="newRec._source.firstname"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-card shadow="hover" :body-style="{ padding: '10px' }">
          ...
          <el-row>
            <el-form-item
              label="Type de Gâteaux"
              :label-width="formLabelWidth2"
              prop="cake.type"
            >
              <el-select
                v-model="newRec._source.cake.type"
                filterable
                placeholder="Sélectionner"
                @change="changeCake"
              >
                <el-option
                  v-for="(item, type) in cakeTypes"
                  :key="type"
                  :label="item"
                  :value="item"
                >
            ...
            <el-form-item
              v-if="newRec._source.cake.type == 'Number Cake'"
              label="Taille"
              :label-width="formLabelWidth2"
            >
              <el-select v-model="size" filterable placeholder="Sélectionner">
                <el-option
                  v-for="(item, size) in sizesNumberCake"
                  :key="size"
                  :label="size"
                  :value="size"
                >
            ...
            <el-form-item
              v-else-if="newRec._source.cake.type == 'Glace'"
              label="Taille"
              :label-width="formLabelWidth2"
            >
              <el-select v-model="size" filterable placeholder="Sélectionner">
                <el-option
                  v-for="(item, size) in sizesIce"
                  :key="size"
                  :label="size + ' ' + item.desc"
                  :value="size"
                >
                </el-option>
              </el-select>
            ...
            <el-form-item
              v-if="newRec._source.cake.type == 'Crème fraîche fruits'"
              label="Intérieur"
              :label-width="formLabelWidth2"
              prop="taste"
            >
              <el-select
                v-model="newRec._source.cake.cremeGout1"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, cremeGout1) in cremeGout1"
                  :key="cremeGout1"
                  :label="item"
                  :value="item"
                >
            ...
            >
              <el-select
                v-model="newRec._source.cake.cremeGout2"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, cremeGout2) in cremeGout2"
                  :key="cremeGout2"
                  :label="item"
                  :value="item"
                >
            ...
            <el-form-item
              v-if="newRec._source.cake.type == 'Spécial Patron'"
              label="Intérieur"
              :label-width="formLabelWidth2"
              prop="taste"
            >
              <el-select
                v-model="newRec._source.cake.patronGout1"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, patronGout1) in patronGout1"
                  :key="patronGout1"
                  :label="item"
                  :value="item"
                >
            ...
            >
              <el-select
                v-model="newRec._source.cake.patronGout2"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, patronGout2) in patronGout2"
                  :key="patronGout2"
                  :label="item"
                  :value="item"
                >
            ...
            <el-form-item
              v-if="newRec._source.cake.type == 'Bavarois'"
              label="Goût Intérieur&Extérieur"
              :label-width="formLabelWidth2"
              prop="taste"
            >
              <el-select
                v-model="newRec._source.cake.bavaroisType"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, bavaroisType) in bavaroisTypes"
                  :key="bavaroisType"
                  :label="item"
                  :value="item"
                >
            ...
            <div v-if="newRec._source.cake.type == 'Glace'">
              <el-form-item
                v-if="size == '4P' || size == '6P'"
                label="Goût"
                :label-width="formLabelWidth2"
                prop="taste"
              >
                <el-select
                  v-model="glaceGoutSolo"
                  filterable
                  placeholder="Sélectionner"
                >
                  <el-option
                    v-for="(item, glaceGout) in glaceGouts"
                    :key="glaceGout"
                    :label="item"
                    :value="item"
                  >
            ...
            >
              <el-select
                v-model="newRec._source.cake.numberCakeType"
                filterable
                placeholder="Sélectionner"
              >
                <el-option
                  v-for="(item, numberCakeType) in numberCakeTypes"
                  :key="numberCakeType"
                  :label="item"
                  :value="item"
                >
            ...
            <div v-if="newRec._source.cake.type == 'Number Cake'">
              <el-form-item
                v-if="
                  newRec._source.cake.numberCakeType != 'Crème Fraîche Nature'
                "
                label="Intérieur"
                :label-width="formLabelWidth2"
                prop="taste"
              >
                <el-select
                  v-model="newRec._source.cake.numberCakeGout"
                  filterable
                  placeholder="Sélectionner"
                >
                  <el-option
                    v-for="(item, numberCakeGout1) in numberCakeGout1"
                    :key="numberCakeGout1"
                    :label="item"
                    :value="item"
                  >
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, numberCakeGout2) in numberCakeGout2"
                    :key="numberCakeGout2"
                    :label="item"
                    :value="item"
                  >
              ...
              >
                <el-input
                  ...
                  minlength="1"
                  size="small"
                  v-model="newRec._source.cake.numberCakeChars"
                  autocomplete="off"
                  placeholder="Vos caractères"
                ></el-input>
              </el-form-item>
            </div>

            <!--el-form-item label="Remarques :" :label-width="formLabelWidth2" >
                      <el-input size="small" v-model="newRec._source.cake.remarqu run seres" autocomplete="off" placeholder="Vos remarque..."></el-input>
                  </el-form-item-->
            <el-row>
              <el-col :span="8">
                <el-form-item
                  v-if="newRec._source.cake.type != 'Number Cake'"
                  label="Envois photo par mail ?"
                  :label-width="formLabelWidth2"
                >
                  <el-switch v-model="imageByMail"> </el-switch>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item
                  v-if="
                    imageByMail && newRec._source.cake.type != 'Number Cake'
                  "
                  label="Mail :"
                  :label-width="formLabelWidth2"
                  prop="mail"
                >
                  <el-input
                    ...
                    v-model="mail"
                    autocomplete="off"
                    placeholder="Mail expéditeur de l'image"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <div v-if="newRec._source.cake.type != 'Number Cake'">
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item
                    v-if="isInscription"
                    label="Inscription personnalisée ?"
                    :label-width="formLabelWidth2"
                  >
                    <el-switch
                      v-model="customInscription"
                      @change="changeInscription"
                    >
                    </el-switch>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item
                    v-if="customInscription && isInscription"
                    label="Inscription (sur le gâteaux):"
                    :label-width="formLabelWidth"
                  >
                    <el-input
                      size="small"
                      v-model="inscription"
                      autocomplete="off"
                      placeholder="Inscription sur le Gâteaux"
                    ></el-input>
                  </el-form-item>
                  <el-form-item
                    v-else-if="isInscription"
                    label="Inscription :"
                    :label-width="formLabelWidth2"
                  >
                    <el-select
                    ...
                    >
                      <el-option
                        v-for="(item, txt) in inscriptions"
                        :key="txt"
                        :label="item"
                        :value="item"
                      >
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item
                    ...
                    :label-width="formLabelWidth2"
                  >
                    <el-switch v-model="isInscription"> </el-switch>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item
                  ...
                  :label-width="formLabelWidth2"
                >
                  <el-switch v-model="isDecoration"> </el-switch>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item
                ...
                >
                  <el-select
                    v-model="newRec._source.cake.decoGender"
                    filterable
                    placeholder="Sélectionner"
                  >
                    <el-option
                      v-for="(item, numberCakeGender) in numberCakeGenders"
                      :key="numberCakeGender"
                      :label="item"
                      :value="item"
                    >
                    </el-option>
              ...
              <el-col :span="6">
                ...
                >
                  ...
                  >
                    <el-option
                      v-for="(item1, txt1) in decorations"
                      :key="txt1"
                      :label="item1"
                      :value="item1"
                    >
              ...
              <el-col :span="6">
                <el-form-item
                  ...
                  prop="age"
                >
                  <el-input-number :min="0" size="small" v-model="age">
                  </el-input-number>
                </el-form-item>
              </el-col>
            </el-row>
...
export default {
  ...
  data: () => ({
    ...
    decosTypes: {
      Homme: [
        'Macarons + Noeud papillons',
        'Macarons + Assortiment Papa',
        'Macarons + Mix Outils',
        'Macarons + Kinder Oréo',
      ],
      Femme: [
        'Macarons Roses + Pétales',
        'Pastels',
        'Déco Dorée',
        'Habits Dame',
      ],
    ...
    rules: {
      cake: {
        type: [
          {
            required: true,
            message: 'Veuillez sélectionner un type de gâteaux',
            trigger: 'blur',
          },
        ],
      },
      taste: [
        {
          required: true,
          message: 'Veuillez sélectionner un goût',
          trigger: 'blur',
        },
      ],
      magasin: [
      ...
      caract: [
        {
          required: true,
          message: 'Veuillez entrer les caractères du gâteau',
          trigger: 'blur',
        },
      ],
      numberDeco: [
        {
          required: true,
          message: 'Veuillez choisir une décoration',
          trigger: 'blur',
        },
      ],
      typeDeco: [
      ...
      age: [
        { required: true, message: 'Veuillez entrer un âge', trigger: 'blur' },
      ],
      mail: [
        {
          required: true,
          message: 'Veuillez entrez un format email correct',
          trigger: 'blur',
        },
      ],
      mailDesc: [
  ...
  computed: {
    ...
    disabled: function () {
      if (
        this.$store.getters.timeRangeDay[0].getTime() <
          Date.now() + 172800000 &&
        !this.isAdmin
      ) {
        return true
    ...
    editableMagasin: function () {
      ...
      if (
        this.$store.getters.currentSubCategory.fulltitle == 'commandes/gâteaux'
      ) {
        return true
      } else {
        return false
    ...
    magasinStr: function () {
      ...
      if (
        ...
        console.log('coucou1')
        console.log(
          this.$store.getters.activeApp.config.hiddenQuery.substring(9)
        )
        console.log('coucou2')
        console.log(this.$store.getters.actualShop)
        console.log('coucou3')
        ...
        //magasin = magasin.replace('"', '')
        var magasin =
          this.$store.getters.actualShop +
          ' (' +
          this.$store.getters.actualShopID +
          ')'
    ...
    totalTTC: function () {
      ...
      if (
        (this.isInscription && this.customInscription) ||
        (this.isInscription && this.newRec._source.cake.type == 'Number Cake')
      ) {
        price += 5
...
*/
    ...
    getMagasins() {
      ...
      for (var priv in this.$store.getters.privileges) {
        ...
        if (
          this.$store.getters.privileges[priv]['_source']['value'] == 'admin'
        ) {
          this.isAdmin = true
    ...
    saveRecord: function () {
      ...
      if (
        this.newRec._source.cake.type == null ||
        this.selectedShop == '' ||
        (this.newRec._source.cake.type == 'Bavarois' &&
          this.newRec._source.cake.bavaroisType == null) ||
        (this.newRec._source.cake.type == 'Crème fraîche fruits' &&
          this.newRec._source.cake.cremeGout1 == null) ||
        (this.newRec._source.cake.type == 'Crème fraîche fruits' &&
          this.newRec._source.cake.cremeGout2 == null) ||
        (this.newRec._source.cake.type == 'Spécial Patron' &&
          this.newRec._source.cake.patronGout1 == null) ||
        (this.newRec._source.cake.type == 'Spécial Patron' &&
          this.newRec._source.cake.patronGout2 == null) ||
        (this.newRec._source.cake.type == 'Glace' &&
          this.glaceGoutSolo == '' &&
          this.glacesGoutDuo.length == 0) ||
        (this.newRec._source.cake.type == 'Number Cake' &&
          (this.newRec._source.cake.numberCakeType == null ||
            this.newRec._source.cake.numberCakeChars == null))
      ) {
        console.log('In if')
        console.log(this.newRec._source.magasin)
        console.log(this.selectedShop)
        ...
        (this.newRec._source.cake.decoGender == '' ||
          this.decoration == '' ||
          this.age == 0)
      ) {
        this.submitForm('ruleForm')
      } else if (
        this.imageByMail == true &&
      ...
      if(!this.submitForm('ruleForm'))
      {
        ...
        this.newRec._source.dateDelivery =
          this.$store.getters.timeRangeDay[0].getTime()
        ...
        if (
          this.newRec._source.type == 'Number Cake' &&
          this.newRec._source.age == null
        ) {
        ...
        if (this.newRec._source.type == 'Glace') {
          if (
            this.newRec._source.size == '4P' ||
            this.newRec._source.size == '6P'
          ) {
