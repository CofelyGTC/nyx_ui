          ...
          <el-col :span="8">
            <el-form-item label="Magasin" :label-width="formLabelWidth">
              <el-select
                v-model="shop"
                placeholder="Sélectionner"
                @change="shopChange(shop)"
              >
                <el-option
                  v-for="(item, id2) in shops"
                  :key="id2"
                  :label="item"
                  :value="item"
                >
          ...
          <el-col :span="8">
            <el-form-item label="Magasin ID" :label-width="formLabelWidth">
              <el-select
                v-model="shopid"
                placeholder="Sélectionner"
                @change="idChange(shopid)"
              >
                <el-option
                  v-for="(item, id3) in ids"
                  :key="id3"
                  :label="item"
                  :value="item"
                >
