      ...
      <el-tab-pane label="Main" name="main">
        <el-card style="margin-bottom: 20px" shadow="never">
          <el-row style="text-align: left" type="flex">
            ...
            <el-col :span="5">
              <el-button @click="setFocus('runner')" type="text"
                >Runner</el-button
              >
            </el-col>
            <el-col :span="5">
              <el-button @click="setFocus('notebook')" type="text"
                >File</el-button
              >
            </el-col>
            <el-col :span="5">
              <el-button @click="setFocus('function')" type="text"
                >Function</el-button
              >
            </el-col>
          </el-row>
          ...
          >
            ...
            <el-col :span="5">
              <v-icon
                :style="'color:' + newRec._source.result_icon.split('>')[1]"
                :name="newRec._source.result_icon.split('>')[0]"
                scale="1.5"
              />
            </el-col>
            <el-col :span="4" style="text-align: right">
          ...
          >
            <el-col :span="10">
              <el-button @click="setFocus('runId')" type="text"
                >Run Uuid</el-button
              >
            </el-col>
            <el-col :span="10">
              <el-button @click="setFocus('return')" type="text"
                >Return</el-button
              >
            </el-col>
          </el-row>
                ...
                <template slot-scope="{ item }">
                  <div class="value">
                    <span style="font-weight: bold"
                      >{{ item.time | formatTS2 }} -&nbsp;</span
                    >
                    <span>({{ item.duration }}ms)</span>
                    <el-icon style="color: red; float: right; margin-top: 10px"
                      ><el-icon-close
                    /></el-icon>
                    <el-icon
...
export default {
  ...
  methods: {
    ...
    createFunction: function () {
      ...
      this.newRec._source.file = this.newRec._source.file
        .toLowerCase()
        .replace(/[^a-zA-Z0-9]+/g, '')
      if (this.newRec._source.file.indexOf('.ipynb') == -1)
        this.newRec._source.file =
          this.newRec._source.file.replace('.', '') + '.ipynb'
