    ...
    <el-form v-model="newRec._source">
      <el-card shadow="hover" :body-style="{ padding: '10px' }">
        ...
        <el-form-item label="Last Update" :label-width="formLabelWidth">
          <el-date-picker
            :disabled="editMode != 'create'"
            v-model="newRec._source.LastUpdate"
            type="date"
            format="yyyy/MM/dd"
        ...
        <el-form-item label="Entretiens réalisés" :label-width="formLabelWidth">
          <el-checkbox-group v-model="maintenancesMade">
            <el-checkbox
              ...
              v-model="maintenance.maintenanceDone"
              :label="maintenance._id"
              :key="maintenance.maintenanceDone"
              >{{ maintenance._id }} ({{
                maintenance._source.maintenance_interval
              }}
              heures)</el-checkbox
            >
          </el-checkbox-group>
...
export default {
  ...
  computed: {
    ...
    recchanged: function () {
      return (
        JSON.stringify(this.recordin) != JSON.stringify(this.newRec) ||
        this.maintenancesMade.length > 0
      )
    },
  },
  props: {
  ...
  methods: {
    ...
    getMaintenances: function () {
      var url =
        ...
        'generic_search/maintenance_parameters?token=' +
