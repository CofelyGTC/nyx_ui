        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="Lastname" :label-width="formLabelWidth">
              <el-input
                size="small"
                v-model="newRec._source.lastname"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="6">
            ...
            >
              <el-input-number
                size="small"
                v-model="newRec._source.seniority"
                :min="0"
                :max="150"
              ></el-input-number>
            </el-form-item>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="Location" :label-width="formLabelWidth">
              <el-input
                size="small"
                v-model="newRec._source.location"
                autocomplete="off"
              ></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item
              ...
              style="text-align: left"
            >
              <el-switch v-model="newRec._source.break"> </el-switch>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item label="Break Duration" :label-width="formLabelWidth">
              <el-input-number
                ...
                size="small"
                v-model="newRec._source.break_duration"
                autocomplete="off"
              ></el-input-number>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    saveRecord: function () {
      ...
      if (
        this.newRec._source.return_date != null ||
        this.newRec._source.return_date != ''
      ) {
        if (this.newRec._source.accident_date != null)
          this.newRec._source.return_date = this.newRec._source.accident_date
        else delete this.newRec._source.return_date
      }
