<template>
  ...
  >
    <el-card v-if="record" shadow="never">
      <h1>
        Name: <b>{{ record._source.name }}</b>
      </h1>
      <h2>
        Image: <b>{{ record._source.image }}</b>
      </h2>
      ...
      <el-row>
        <el-col :span="24">
          <el-select v-model="action" ref="type" size="small" placeholder="Mode">
            <el-option
          ...
          &nbsp;
          <el-button @click="sendMessage" type="danger" size="small"
            >Send</el-button
          >
        </el-col>
      </el-row>
