  ...
  >
    <span v-if="newScriptVisible">
      <NewScript
        ...
        v-on:newscriptclose="newScriptVisible = false"
      ></NewScript>
    </span>
    <div v-if="accepted <= 0">
      <el-button
      ...
      <el-form v-model="newRec._source">
        <el-card shadow="hover" :body-style="{ padding: '10px' }">
            ...
            <el-col :span="8">
              <el-form-item label="Name" :label-width="formLabelWidth">
                <el-input
                  :disabled="!isAdmin"
                  size="small"
                  v-model="newRec._source.optiboard"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="8">
              ...
              >
                <el-input
                  size="small"
                  v-model="newRec._source.lifesigninterval"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              ...
              >
                <el-input
                  size="small"
                  v-model="newRec._source.pollinterval"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row v-show="isAdmin">
            ...
            <el-col :span="8">
              <el-form-item
                label="Kibana Wrapper"
                :label-width="formLabelWidth"
              >
                <el-input
                  size="small"
                  v-model="newRec._source.kibanawrapper"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="Opti Conso ID" :label-width="formLabelWidth">
                <el-input
                  size="small"
                  v-model="newRec._source.opticonsoid"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row v-show="isAdmin">
            <el-col :span="8">
              <el-form-item label="Primary Color" :label-width="formLabelWidth">
                <el-color-picker
                  v-model="newRec._source.primarycolor"
                ></el-color-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              ...
              >
                <el-color-picker
                  v-model="newRec._source.secondarycolor"
                ></el-color-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="Icon URL" :label-width="formLabelWidth">
                <el-input
                  size="small"
                  v-model="newRec._source.iconurl"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
