    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-popover
            v-if="
              (scope.row._source.privileges ? true : false) &&
              scope.row._source.privileges.length > 0
            "
          ...
          >
            ...
            <el-button size="small" slot="reference">{{
              scope.row._source.privileges.length
            }}</el-button>
          </el-popover>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-popover
            v-if="
              (scope.row._source.parameters ? true : false) &&
              scope.row._source.parameters.length > 0
            "
            placement="left-start"
          ...
          >
            ...
            <el-button size="small" slot="reference">{{
              scope.row._source.parameters.length
            }}</el-button>
          </el-popover>
        </template>
      </el-table-column>
