        ...
        <el-tab-pane label="Main" name="main">
          ...
          >
            ...
            >
              ...
              <el-col :span="20">
                A simple report based on a python source code that will generate
                the output.
                <br />
          ...
          <el-row
            v-if="newRec.reportType == 'notebook_doc'"
            class="transition-box"
            style="text-align: left"
          >
            <el-card
            ...
            >
              ...
              <el-col :span="20">
                A report that uses a word template with tags and a python
                notebook to replace the tags by the approriate values.
                <br />
                <br />
              </el-col>
            </el-card>
          ...
          <el-row
            v-if="newRec.reportType == 'notebook'"
            style="text-align: left"
          >
            <el-card
              shadow="never"
            ...
            >
              ...
              <el-col :span="20">
                A report that uses a python notebook to generate the output.
                Ideal to generate Excel files.
                <br />
              </el-col>
            </el-card>
          </el-row>
          <el-row v-if="newRec.reportType == 'jasper'" style="text-align: left">
            ...
            >
              ...
              <el-col :span="20">
                A report that uses Jasper report and Elastic Search. In most
                cases, the output will be a PDF file. <br />
                Download Jasper iReport application from the internet in order
                to create your report.<br />
                <br />
              </el-col>
            </el-card>
          </el-row>
          <el-row
            v-if="newRec.reportType == 'jasper_jdbc'"
            style="text-align: left"
          >
            <el-card
              shadow="never"
            ...
            >
              ...
              <el-col :span="20">
                A report that uses Jasper report and a JDBC compliant database
                such as SQL server or PostgreSQL. <br />
          ...
          <el-row :span="24" v-show="newRec.reportType == 'jasper_jdbc'">
            <el-col :span="12">
              <el-form-item label="JDBC Driver" :label-width="formLabelWidth">
                <el-input
                  size="small"
                  v-model="newRec.jdbc_driver"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="JDBC URL" :label-width="formLabelWidth">
                <el-input
                  size="small"
                  v-model="newRec.jdbc_url"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item
                ...
                :label-width="formLabelWidth"
                v-show="
                  newRec.reportType == undefined ||
                  newRec.reportType == 'python'
                "
              >
                <el-input
                  size="small"
              ...
              <el-form-item
                ...
                :label-width="formLabelWidth"
                v-show="
                  newRec.reportType == 'jasper' ||
                  newRec.reportType == 'jasper_jdbc'
                "
              >
                <el-input
                  size="small"
                  v-model="newRec.jasper"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
              <el-form-item
                ...
                :label-width="formLabelWidth"
                v-show="
                  newRec.reportType == 'notebook' ||
                  newRec.reportType == 'notebook_doc'
                "
              >
                <el-input
                  size="small"
                  v-model="newRec.notebook"
                  autocomplete="off"
                ></el-input>
              </el-form-item>
            </el-col>
    ...
    <span slot="footer" class="dialog-footer">
      <el-row type="flex" class="row-bg" justify="space-between">
        ...
        <el-col>
          ...
          >
          <el-button v-if="isAdd" type="primary" @click="createNewReport()">{{
...
export default {
  ...
  data: () => ({
    ...
    rules: {
      ...
      icon: [
        {
          required: true,
          message: 'Please pick an icon ex:bug',
          trigger: 'change',
        },
      ],
    },
  ...
  methods: {
    ...
    openTabCode: function () {
      window.open(
        './ipython/notebooks/reports/notebooks/' +
          this.newRec.notebook.replace('./', '') +
          '.ipynb'
      )
    },
