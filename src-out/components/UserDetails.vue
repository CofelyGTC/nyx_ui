        ...
        <el-collapse-item :title="this.$t('generic.privileges')" name="2">
          <el-row style="padding-left: 30px">
            <el-transfer
              ...
              :data="privilegesdata"
              :titles="[
                this.$t('generic.available'),
                this.$t('generic.assigned'),
              ]"
            ></el-transfer>
          </el-row>
        </el-collapse-item>
