    ...
    <div class="select-bar-container">
      ...
      >
        ...
        <el-input
          ...
          style="width: 170px"
          v-if="
            queryfilter.type == 'text' ||
            queryfilter.type == 'text_strict' ||
            queryfilter.type == 'globaltext'
          "
  ...
  methods: {
    ...
    refreshLinkedCombo: function (filterchangedindex) {
      for (let queryind in this.queryFilterCopy) {
        ...
        this.$store.getters.searchCache[cacheKey] =
        ...
        if (this.queryFilterCopy[queryind].type == 'globaltext') {
          ...
          if (valq == undefined) {
            if (
              ...
              valq =
                this.queryFilterCopy[queryind].selectOptions[0].split('=')[0]
            } else {
              console.error(
