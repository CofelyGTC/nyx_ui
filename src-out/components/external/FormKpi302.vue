  ...
  <div>
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="80%">
      <el-form
        ...
        ref="formCall"
      >
        <el-form-item label="Datum van spotcheck" :label-width="formLabelWidth">
          <el-date-picker
            :shortcuts="
              { firstDayOfWeek: 1 } && { firstDayOfWeek: 1 }.shortcuts
            "
            :disabled-date="
        ...
        <el-form-item label="Gebouw" :label-width="formLabelWidth">
          <el-select
            size="small"
            v-model="dialogObj.building"
            :disabled="disable"
            placeholder="Select"
        ...
        <el-form-item label="Verdieping" :label-width="formLabelWidth">
          <el-select
            size="small"
            v-model="dialogObj.floor"
            :disabled="disable"
            placeholder="Select"
          >
            <el-option
        ...
        <el-form-item label="Resultaat " :label-width="formLabelWidth">
          <el-select
            size="small"
            v-model="dialogObj.conform"
            :disabled="disable"
            placeholder="Select"
          >
            <el-option key="1" label="Conform" :value="true"> </el-option>
            <el-option key="0" label="Niet Conform" :value="false"> </el-option>
          </el-select>
        </el-form-item>

        <el-form-item
          v-if="!dialogObj.conform"
              ...
              <template slot-scope="scope" v-if="!scope.row._source.conform">
                ...
                >
                  <el-button
                    type="text"
                    v-bind:class="{
                      redduration: formatend(scope.row),
                      greenduration: !formatend(scope.row),
                    }"
                    slot="reference"
            ...
            >
              <template slot-scope="scope">
                <v-icon
                  name="times"
                  scale="1.0"
                  v-if="!scope.row._source.conform"
                />
                <v-icon
                  name="check"
                  scale="1.0"
                ...
                <!-- <div style="text-align:center;" >
                      <v-icon icon="fa-bug" scale="1.5"/>
                    </div> -->
              </template>
            </el-table-column>

            <el-table-column label="Gebouw" width="120" sortable>
              <template slot-scope="scope">
      ...
      buildings: [
        {
          ...
          floors: [
            'Floor K (0) Kelder',
            'Floor E (1) Tussenkelder',
            'Floor P (2) Platform',
            'Floor A (3) Aankomst/Vertrek',
            'Floor M (4) Mezzanine',
            'Floor T (5) Techniek',
            'Floor L (6) Koeltorens',
            'Floor D (7) Dak',
          ],
        },
        {
          ...
          floors: [
            ...
            'Floor A (2) Aankomst',
            'Floor V (3) Vertrek',
            'Floor S (4) Salondiensten',
            'Floor D (5) Dak',
          ],
        },
        {
          building: '001 C',
          floors: ['Floor K (-2) Kelder', 'Floor P (0) Inschepingsvloer'],
        },
        {
          building: '001 G',
          floors: [
            'Floor 0 (0) Platform',
            'Floor 1 (1) Aankomst/Vertrek',
            'Floor 2 (2) Aankomst',
            'Floor 4 (3) Mezzanine + Vertrek',
            'Floor T (4) Tussentechniek',
            'Floor 5 (5) Techniek',
            'Floor 6 (6) Dak',
          ],
        },
        {
          building: '001 New',
          floors: [
            'Floor U (-3) Kruipkelder',
            'Floor K (-2) Kelder',
            'Floor E (-1) Technisch plafond',
            'Floor P (0) Platform',
            'Floor I (1) Tussenverdieping',
            'Floor A (2) Aankomst',
            'Floor V ( 3) Vertrek',
            'Floor M (4) Mezzanine',
            'Floor B (5) Burelen',
            'Floor T (6) Techniek + parking',
            'Floor S (7) Stand & gate',
            'Floor D (8) Dak',
          ],
        },
        {
          building: '001 Old',
          floors: [
            'Floor K (-3) 2&3 ondervloer',
            'Floor 0 (-2) Level 00',
            'Floor M (-1) Motorfiets Parking',
            'Floor 1 (0) Level 01 Platform',
            'Floor I (1) Tussenv. Sanitair',
            'Floor 2 (2) Level 02 Aankomst',
            'Floor 3 (3) Level 03 Vertrek',
            'Floor 4 (4) Level 04',
            'Floor 5 (5) Level 05',
            'Floor 6 (6) Level 06',
            'Floor 7 (7) Level 07',
            ...
            'Floor 9 (9) Level 09',
            'Floor A (10) Level 10',
            'Floor B (11) Controletoren11',
            'Floor C (12) Controletoren12',
            'Floor D (13) Dak',
          ],
        },
        { building: '001 Tun', floors: ['Floor K (0) Tunnel'] },
        {
          building: '001 W',
          floors: ['Floor K (-1) Kelder', 'Floor E (0) Tussenkelder'],
        },
        {
          building: '056',
          floors: [
            'Floor G (0) Gelijkvloers',
            'Floor V (1) Verdieping',
            'Floor D (2) Dak',
          ],
        },
        { building: '034', floors: ['Floor G (0) Gelijkvloers'] },
        {
          building: '026',
          floors: ['Floor K (-1) Kelder', 'Floor G (0) Gelijkvloers'],
        },
        { building: '016', floors: ['Floor G (0) Gelijkvloers'] },
        {
          building: '001 M',
          floors: [
            'Floor K (-1) Kelder',
  ...
  methods: {
    ...
    dateSelected() {
      ...
      axios
        .post(url, fullq)
        .then((response) => {
          if (response.data.error != '') console.log('KPI302 list error...')
          else {
