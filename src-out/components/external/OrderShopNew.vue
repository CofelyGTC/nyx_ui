              ...
              >
                ...
                <div style="bottom: 5%">
                  <el-row
                    ...
                    Pâtisserie TTC : {{ totalPatisserie | roundTo2 }} € Total
                    Autres TTC : {{ totalOther | roundTo2 }} €</el-row
                  >
...
export default {
  ...
  methods: {
    ...
    createNewForm() {
      ...
      var url =
        this.$store.getters.apiurl +
        'generic_search/products_parameters_new?token=' +
        this.$store.getters.creds.token
          ...
          for (var i in response.data.records) {
            ...
            if (response.data.records[i]._source.avail == 'always') {
              ...
              var period = JSON.parse(
                response.data.records[i]._source.availabilityConf
              )
