    ...
    <el-row class="stockvieweroffice-container" style="width: 100%">
      <el-form style="widht: 100%">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item
              label="Traîneau vanille-framboise "
              :label-width="formLabelWidth2"
            >
  ...
  methods: {
    onSubmit() {
      ...
      var url =
        ...
        'lambdas/7/update_stocks_coeurs?apikey=' +
    ...
    getData() {
      ...
      var url =
        this.$store.getters.apiurl +
        'lambdas/7/get_stock_coeurs?apikey=' +
        this.$store.getters.creds.token
      axios.post(url, query).then((response) => {
        //var status = false
