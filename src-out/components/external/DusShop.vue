  ...
  <div style="width: 100%">
    <el-row class="dushop-container" style="width: 100%">
      ...
      <el-row style="width: 100%">
        <el-col :span="4">
          <label style="horizontal-align: right; vertical-align: middle"
            >Remise Totale (€):
          </label>
        </el-col>
        <el-col :span="4">
      ...
      <el-form style="widht: 100%" :disabled="this.disabled">
        <el-tabs v-model="selectedTab" @tab-click="tabChanged(selectedTab)">
          ...
          >
            ...
            <el-row> Total Dus: {{ totalPrice | roundTo2 }}€ TTC </el-row>
            <el-row>
              <br /><br />
...
export default {
  ...
  methods: {
    ...
    setSacAPain() {
      if (
        this.shopSacAPain.includes(this.magasin) ||
        this.shopSacAPainID.includes(this.shopid)
      ) {
        this.sacapain = true
      } else {
        this.sacapain = false
        ...
        if (response.data.error != '')
          ...
          if (res.reccords.length == 0) {
            ...
            this.supplementSales =
              res.reccords[0]['_source']['supplementsSales']
        ...
        if (response.data.error != '')
          ...
          for (var i in response.data.records) {
            ...
            if (response.data.records[i]._source._id == 'P020') {
              console.log('******** P020 *********')
              console.log(
                JSON.parse(JSON.stringify(response.data.records[i]._source))
              )
            }
