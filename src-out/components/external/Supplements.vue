<template>
  <div style="width: 100%">
    <el-row class="supplement-container" style="width: 100%">
      <el-form style="widht: 100%" :disabled="this.disabled">
        <el-tabs v-model="selectedTab" @tab-click="tabChanged(selectedTab)">
          ...
          >
            <el-tabs v-model="selectedUnderTab" @tab-click="subTabChanged()">
              ...
              >
                ...
                <div style="bottom: 5%">
                  Total Sélection: {{ totalFiltered | roundTo2 }}€ Total Panier
                  TTC : {{ totalPrice | roundTo2 }} €
          ...
          >
            ...
            <el-row> Total Invendus: {{ totalPrice | roundTo2 }}€ TTC </el-row>
            <el-row>
              <br /><br />
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      var url =
        this.$store.getters.apiurl +
        'schamps/check_supplements?shop=' +
        magasin +
        '&demandor=' +
        demandor +
        '&start=' +
