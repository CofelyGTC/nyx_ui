    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span style="font-weight: bold"
          >KPI304 - Aanwezigheid van de minimale bemanning</span
        >
      </div>
      <div class="card-body">
        <el-row>
          ...
          <el-col :span="12" style="text-align: right">
            ...
            <el-row
              v-for="ppl in kpi304DataModel[selectedLot][selectedTec].ppl.titu"
              :key="ppl"
              >{{ ppl }}</el-row
            >
            <el-row><b>Back up verantwoordelijke</b></el-row>
            <el-row
              v-for="ppl in kpi304DataModel[selectedLot][selectedTec].ppl
                .backup"
              :key="ppl"
              >{{ ppl }}</el-row
            >
          ...
          >
            ...
            <el-row v-for="item in kpi304Model" :key="item['@timestamp']">
              ...
              <el-col
                ...
                v-if="
                  !isWeekEnd(item.date) &&
                  kpi304DataModel[selectedLot][selectedTec].tech == 1
                "
              >
                <el-switch
                  v-if="!item.off"
              ...
              <el-col
                ...
                v-if="
                  !isWeekEnd(item.date) &&
                  kpi304DataModel[selectedLot][selectedTec].tech == 2
                "
              >
                <el-switch
                  v-if="!item.off"
  ...
  methods: {
    ...
    getData() {
      ...
      axios
        ...
        .then((response) => {
          if (response.data.error != '') console.log('get KPI304 monthly error')
          else {
