          ...
          <el-table-column prop="confirmed" label="Confirmé">
            <template slot-scope="scope">
              <el-switch
                ...
                @change="recordConfirmed(scope.row)"
              ></el-switch>
            </template>
          </el-table-column>
          <el-table-column
          ...
          <el-table-column label="Quantité Produite">
            <template slot-scope="scope">
              <el-input-number
                ...
                @changed="recordModify(scope.row)"
              />
            </template>
          </el-table-column>
  ...
  methods: {
    prepareData() {
      ...
      this.params = JSON.parse(
        this.$store.getters.activeApp.config.controllerparameters
      )
    ...
    getData() {
      ...
      var url =
        ...
        'schamps/getProductionResult?start=' +
        timeRange[0].getTime() +
        '&stop=' +
        timeRange[1].getTime() +
        '&filter=' +
