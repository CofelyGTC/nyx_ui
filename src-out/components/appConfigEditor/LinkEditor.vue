<template>
  ...
  >
    <el-card shadow="never" v-if="curItem">
      ...
      <el-row>
        <el-switch v-model="curItem.linkbuttonplain"> </el-switch>
      </el-row>
      <el-row>
        <el-button type="text">Button Round</el-button>
      </el-row>
      <el-row>
        <el-switch v-model="curItem.linkbuttonround"> </el-switch>
      </el-row>
      <el-row>
        <el-button type="text">Button Circle</el-button>
      </el-row>
      <el-row>
        <el-switch v-model="curItem.linkbuttoncircle"> </el-switch>
      </el-row>
    </el-card>
  </el-dialog>
</template>
...
export default {
  ...
  created: function () {
    ...
    if (this.curItem.linktext == null) this.curItem.linktext = 'link text'
    if (this.curItem.linkbuttontype == null) this.curItem.linkbuttontype = ''
