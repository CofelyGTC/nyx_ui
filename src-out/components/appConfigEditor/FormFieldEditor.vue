<template>
  ...
  >
    <el-form v-if="curField" :model="curField">
      ...
      <el-row
        :gutter="20"
        v-if="curField.type == 'string' || curField.type == 'number'"
      >
        <el-col :span="20">
          <el-form-item label="Default" :label-width="formLabelWidth">
            <el-input
              size="small"
              v-model="curField.default"
              autocomplete="off"
            ></el-input>
          </el-form-item>
        </el-col>
