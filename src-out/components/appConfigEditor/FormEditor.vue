    ...
    <el-card>
      ...
      <div>
        <el-row style="text-align: left">
          <el-col :span="7">
            <el-row>
              <el-button @click="setFocus('formtitle')" type="text"
                >Form title</el-button
              >
            </el-row>
            <el-row>
              <el-input
          ...
          <el-col :offset="3" :span="6">
            ...
            <el-row>
              <el-radio-group
                v-model="currentConfig.config.formmode"
                size="small"
                ref="mode"
              >
          ...
          <el-col
            :offset="1"
            :span="7"
            v-if="currentConfig.config.formmode == 'table'"
          >
            <el-row>
              <el-button @click="setFocus('index')" type="text"
                >Index</el-button
              >
            </el-row>
            <el-row>
                ...
                <el-table-column prop="title" label="Action">
                  <template slot-scope="scope2">
                    ...
                    <el-button
                      ...
                      v-if="
                        scope2.$index <
                        currentConfig.config.headercolumns.length - 1
                      "
                    ></el-button>
                    <el-button
                      size="small"
