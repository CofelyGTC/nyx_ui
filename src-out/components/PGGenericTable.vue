...
export default {
  ...
  created: function () {
    ...
    if (
      this.config.config.sort_column != undefined &&
      this.config.config.sort_column != ''
    ) {
      this.sort = { column: this.config.config.sort_column }
      if (
        this.config.config.sort_order != undefined &&
        this.config.config.sort_order != ''
      )
