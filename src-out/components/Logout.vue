  ...
  <span>
    <el-dropdown @command="handleCommand">
      <el-button type circle>
        <div style="width: 16px; height: 16px; font-size: 14px">
          {{ $store.getters.creds.user.firstname[0] }}
        </div>
      </el-button>
