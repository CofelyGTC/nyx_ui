...
export default {
  ...
  methods: {
    ...
    prepareData: function () {
      ...
      if (
        this.config.config.colorfunction != undefined &&
        this.config.config.colorfunction != ''
      ) {
      ...
      if (
        this.config.config.iconfunction != undefined &&
        this.config.config.iconfunction != ''
      ) {
        ...
        if (typeof res == 'string') {
          if (res.indexOf(',') > 0) {
            var newm = {
              ...
              latlng: L.latLng(res.split(',')[0], res.split(',')[1]),
            }
