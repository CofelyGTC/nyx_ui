<template>
  <div style="position: relative">
    <el-dialog
      ...
      width="65%"
    >
      <el-table size="small" max-height="400" border :data="procWindowDetails">
        <el-table-column
          prop="0"
          label="Field"
          min-width="150"
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="8">
            <el-form-item label="Lifesign Timeframe">
              <el-select v-model="selectedTimeframe" size="small">
                <el-option
        ...
        .then((response) => {
          if (response.data.error != '') console.log('Process list error...')
            ...
            for (let i in keyArray) {
              ...
              else data.push([keyArray[i], source[keyArray[i]]])
            }
