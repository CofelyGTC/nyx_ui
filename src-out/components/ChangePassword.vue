  ...
  >
    ...
    >
      ...
      >
        <el-input
          ...
          type="password"
          autocomplete="none"
          v-model="cpform.newpassword1"
        />
      </el-form-item>
      <el-form-item
        class="formitem"
        :label="$t('changepassword.repeatpass')"
        prop="newpassword2"
      >
        <el-input
          size="small"
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button
        type="primary"
        :disabled="
          cpform.newpassword1 != cpform.newpassword2 ||
          cpform.newpassword2.length < 8
        "
