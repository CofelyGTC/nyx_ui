<template>
  ...
  >
    <el-form :model="curConfig">
      <el-tabs v-model="activeName" @tab-click="refresh2">
        <el-tab-pane label="Main" name="main" key="main">
          <el-card>
              ...
              <el-col :span="8">
                ...
                >
                  ...
                  >
                    ...
                    <el-option
                      label="Lazy ES Table"
                      value="lazy-generic-table"
                    ></el-option>
                    <el-option
                      label="PGSQL Table"
                      value="pgsql-generic-table"
                    ></el-option>
            ...
            >
              <el-card
                shadow="never"
                style="height: 70px; background-color: rgb(236, 245, 255)"
              >
                <el-col
                  :span="4"
            ...
            <el-row
              v-if="
                curConfig.type === 'generic-table' ||
                curConfig.type === 'lazy-generic-table'
              "
              class="transition-box"
              style="text-align: left"
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  It displays the data as a table that can optionaly include a
                  time line or a map.<br />
            ...
            >
              <el-card
                shadow="never"
                style="height: 90px; background-color: rgb(236, 245, 255)"
              >
                <el-col
                  :span="4"
                  style="text-align: right; padding-right: 20px"
            ...
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  It the external url contains <b>token=TOKEN</b>, the
                  <b>TOKEN</b> tag is replaced by the actual user token.<br />
                  <br />
                </el-col>
              </el-card>
            </el-row>
            ...
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  The file is sent to an ActiveMQ destination and can be handled
                  by Camel, NodeRed or a Lambda.<br />
                  <br />
                </el-col>
              </el-card>
            </el-row>
            ...
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  The file system must be shared with the nyx_ui container via
                  Docker.<br />
                  <br />
                </el-col>
              </el-card>
            ...
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  This controller must be added to the external nyx_ui folder
                  and the UI recompiled.<br />
                  <br />
                </el-col>
              </el-card>
            </el-row>
            ...
            >
              ...
              >
                ...
                <el-col :span="20">
                  ...
                  <br />
                  Fields of the form must be filled by the user. The target of
                  the form can be an elastic search collection or a message.<br />
                  <br />
                </el-col>
              </el-card>
            </el-row>
            ...
            >
              <el-card
                shadow="never"
                style="height: 70px; background-color: rgb(255, 245, 236)"
              >
                <el-col
                  :span="4"
                  style="text-align: right; padding-right: 20px"
            ...
            <el-row
              v-if="curConfig.type === 'vega'"
              class="transition-box"
              style="text-align: left"
            >
              <el-card
                shadow="never"
                style="height: 110px; background-color: rgb(255, 245, 236)"
              >
                <el-col
                  :span="4"
                  style="text-align: right; padding-right: 20px"
                ...
                <el-col :span="20">
                  <b>Experimental</b>
                  <br />
                  Displays a vega visualization. The data must be accessed via a
                  data source defined in NYX.<br />
                  Ex:
                  <b
                    >https://173.242.183.147/api/v1/datasource/my_ds1?token=@TOKEN@&start=@START@&end=@END@</b
                  >
                  START and END are only used if a time selector is checked.
                  <br />
                </el-col>
              </el-card>
            </el-row>
            ...
            >
              <el-col :span="8">
                <el-form-item label :label-width="formLabelWidth">
                  <el-row>
                    <el-switch
                      v-model="curConfig.queryBarChecked"
                  ...
                  <el-row>
                    <el-switch
                      v-model="curConfig.downloadChecked"
              ...
              <el-col :span="8">
                <el-form-item label :label-width="formLabelWidth">
                  <el-row>
                    <el-switch
                      v-model="curConfig.queryFilterChecked"
                  ...
                  <el-row>
                    <el-switch
                      v-model="curConfig.timeSelectorChecked"
              ...
              <el-col :span="8" v-if="curConfig.type === 'pgsql-generic-table'">
                <el-form-item label :label-width="formLabelWidth">
                  <el-row>
                    <el-switch
                      v-model="curConfig.graphicChecked"
                      active-text="Graphic"
                    ></el-switch>
                  </el-row>
                  <el-row>
                    <el-switch
                      v-model="curConfig.mapChecked"
                      active-text="Map"
                    ></el-switch>
                  </el-row>
                </el-form-item>
            ...
            >
              <el-input
                size="small"
                v-model="curConfig.config.controller"
                autocomplete="off"
              ></el-input>
            </el-form-item>
            <el-form-item
        ...
        >
          <el-card>
            ...
            <div>
              ...
              <el-row>
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      size="small"
                      v-model="curConfig.config.index"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      size="small"
                      v-model="curConfig.config.timefield"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      size="small"
                      v-model="curConfig.config.doc_type"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                  <el-form-item
                ...
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      size="small"
                      v-model="curConfig.config.mapfield"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                <el-col :span="6">
                  <el-form-item label="Sort" :label-width="formLabelWidth">
                    <el-input
                      size="small"
                      v-model="curConfig.config.sort_column"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item label="Order" :label-width="formLabelWidth">
                    <el-input
                      size="small"
                      v-model="curConfig.config.sort_order"
              ...
              <el-row>
                ...
                <el-col :span="6">
                  ...
                  >
                    <el-input
                      size="small"
                      v-model="curConfig.config.orderField"
                      autocomplete="off"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item
                    ...
                    "
                  >
                    <el-checkbox v-model="curConfig.config.orderDirection"
              ...
              <el-row>
                <el-col :span="4">
                  <el-button size="small" @click="handleAddField()"
                    >Add Field</el-button
                  >
                </el-col>
                <el-col :span="20">
                  ...
                  >
                    <el-form v-if="currentHeader" :model="currentHeader">
                      ...
                      <el-row
                        :gutter="20"
                        v-if="
                          currentHeader.type == 'date' ||
                          currentHeader.type == 'timestamp'
                        "
                      >
                        <el-col :span="20">
                          <el-form-item
                    ...
                    <span slot="footer" class="dialog-footer">
                      <el-button
                        type="primary"
                        @click="dialogHeaderVisible = false"
                        >Close</el-button
                      >
                    </span>
                  </el-dialog>
                    ...
                    <el-table-column prop="title" label="Action">
                      <template slot-scope="scope2">
                        ...
                        <el-button
                          ...
                          type="primary"
                          @click="
                            handleMoveHeader(scope2.$index, scope2.row, false)
                          "
                          :icon="ElIconArrowDown"
                          v-if="
                            scope2.$index <
                            curConfig.config.headercolumns.length - 1
                          "
                        ></el-button>
                        <el-button
                          size="small"
                          ...
                          type="primary"
                          @click="
                            handleMoveHeader(scope2.$index, scope2.row, true)
                          "
                          :icon="ElIconArrowUp"
                          v-if="scope2.$index > 0"
                        ></el-button>
        ...
        <el-tab-pane
          ...
          v-if="curConfig.type === 'upload'"
        >
          <UploadEditor :currentConfig="curConfig"></UploadEditor>
        </el-tab-pane>
        <el-tab-pane
          label="File System"
          name="filesystem"
          ...
          v-if="curConfig.type === 'file-system'"
        >
          <FileSystemEditor :currentConfig="curConfig"></FileSystemEditor>
        </el-tab-pane>
        ...
        <el-tab-pane
          ...
          v-if="curConfig.type === 'form'"
        >
          <FormEditor :currentConfig="curConfig"></FormEditor>
        </el-tab-pane>
        <!-- FREE TEXT -->
        <el-tab-pane
          label="Free Text"
        ...
        >
          <el-card>
            <FreeTextDetails
              ...
              v-on:freetextchanged="freeTextChanged"
            ></FreeTextDetails>
          </el-card>
        </el-tab-pane>
        <!-- Vega -->
        ...
        <el-tab-pane
          ...
          name="queryfilter"
          v-if="
            (curConfig.type === 'kibana' ||
              curConfig.type === 'generic-table' ||
              curConfig.type === 'lazy-generic-table') &&
            curConfig.queryFilterChecked
          "
        >
          <el-card>
            <div>
              <el-row>
                <el-col :span="4">
                  <el-button size="small" @click="handleAddQueryFilterField()"
                    >Add Field</el-button
                  >
                </el-col>
                <el-col :span="20">
                    ...
                    <el-table-column prop="title" label="Action">
                      <template slot-scope="scope2">
                        ...
                        <el-button
                          ...
                          type="danger"
                          @click="
                            handleDeleteQueryFilter(scope2.$index, scope2.row)
                          "
                          :icon="ElIconDelete"
                        ></el-button>
                        ...
                        <el-button
                          ...
                          v-if="
                            scope2.$index <
                            curConfig.config.queryfilters.length - 1
                          "
                        ></el-button>
                        <el-button
                          size="small"
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button
        :disabled="
          JSON.stringify(curConfig) == JSON.stringify(orgConfig._source) &&
          strNewRec == strOrgRec
        "
        type="primary"
        @click="saveRecord()"
  ...
  methods: {
    ...
    prepareData() {
      ...
      if (this.currentConfig.timeRefreshValue != null)
        this.curConfig.timeRefreshValue = this.curConfig.timeRefreshValue
          .replace('refreshInterval:(pause:!f,value:', '')
          .replace(')', '')
    ...
    computeKibanaUrlFromSelectedDash() {
      ...
      if (this.curConfig.timeRefresh && this.curConfig.timeRefreshValue != null)
        strRefresh =
          'refreshInterval:(pause:!f,value:' +
          this.curConfig.timeRefreshValue +
          ')'

      url += '?embed=true&_g=(' + strRefresh + ',time:(' + timek + '))'
