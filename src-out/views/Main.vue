    ...
    <el-container v-bind:style="styleContainerComputed">
      ...
      <el-header style="text-align: right; font-size: 12px">
        <el-row :gutter="24">
          ...
          <el-col
            :span="5"
            style="text-align: left; font-size: 22px; color: white"
          >
            <span> &nbsp;{{ $store.getters.maintitle }} </span>
          </el-col>
          <el-col
            :span="18"
          ...
          >
            <div
              v-if="
                $store.getters.activeApp.timeSelectorChecked &&
                ($store.getters.activeApp.timeSelectorType == undefined ||
                  $store.getters.activeApp.timeSelectorType == 'classic')
              "
            >
              ...
              <div>
                ...
                >
                  ...
                  <el-button
                    ...
                    >{{ $t('time.last') }} {{ relativeTimeValue }}
                    {{ relativeTimeType }}</el-button
                  >
                </el-popover>
              </div>
              <div
              ...
              >
                <el-date-picker
                  ...
                  "
                  :shortcuts="
                    rangePickerOptions && rangePickerOptions.shortcuts
                  "
                  :disabled-date="
                    rangePickerOptions && rangePickerOptions.disabledDate
                  "
                  :cell-class-name="
                    rangePickerOptions && rangePickerOptions.cellClassName
                  "
                  style="top: 1px"
                  v-model="timerange"
            ...
            <div
              v-if="
                $store.getters.activeApp.timeSelectorChecked &&
                $store.getters.activeApp.timeSelectorType == 'day'
              "
            >
              <!-- day TIME SELECTED -->
              <el-date-picker
            ...
            <div
              v-if="
                $store.getters.activeApp.timeSelectorChecked &&
                $store.getters.activeApp.timeSelectorType == 'week'
              "
            >
              <!-- week TIME SELECTED -->
              <el-date-picker
            ...
            <div
              v-if="
                $store.getters.activeApp.timeSelectorChecked &&
                $store.getters.activeApp.timeSelectorType == 'month'
              "
            >
              <!-- month TIME SELECTED -->
              <el-date-picker
            ...
            <div
              v-if="
                $store.getters.activeApp.timeSelectorChecked &&
                $store.getters.activeApp.timeSelectorType == 'year'
              "
            >
              <!-- year TIME SELECTED -->
              <el-date-picker
      ...
      <el-container>
        <transition name="el-zoom-in-top">
          <el-aside
            width="201px"
            v-bind:style="styleAsideComputed"
            class="aside"
            v-show="menuOpen"
          >
            <el-row class="tac">
...
<script>
import { More as ElIconMore } from '@element-plus/icons'import * as dayjs from 'dayjs';
